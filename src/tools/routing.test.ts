...
describe('Routing Tools', () => {
  describe('routeOverview', () => {
    ...
    it('should format travel time correctly for short durations', async () => {
      ...
      expect(result.content[0].text).toContain('[-149.54858, 60.534715, -149.543469, 60.535008]')
    })
    ...
    it('should include encoded polyline', async () => {
      ...
      expect(result.content[0].text).toContain('wzvmrBxalf|GcCrX}A|Nu@jI}@pMkBtZ{@x^_Afj@Inn@`@veB')
    })
  })
